...
const ProviderDetailContent: React.FC<ProviderDetailContentProps> = ({
  ...
  const operatingHours = provider.operatingHours || [
        ...
        >
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", width: "100%" }}>
                {services.length === 0 ? (
                  <Typography variant="body2" color="text.secondary" sx={{ py: 2 }}>
                    No custom services listed by this provider.
                  </Typography>
                ) : (
            ...
            <Paper elevation={2} sx={{ p: 3, mb: 3, borderRadius: 2 }}>
              ...
              {operatingHours.map((item: any, index: number) => (
                <Box
                  key={index}
                  sx={{
                    display: "flex",
            ...
            <Box sx={{ position: "sticky", top: 100 }}>
              ...
              <Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
                ...
                {(provider.whyChooseUs || [
                  ...
                  let IconComponent = BusinessIcon;
                  if (point.icon === "customers") IconComponent = PeopleIcon;
                  else if (point.icon === "certified") IconComponent = VerifiedIcon;

                  return (
                    <Box
                      key={index}
                      sx={{ display: "flex", alignItems: "center", gap: 2, mb: index < 2 ? 3 : 0 }}
                    >
                      <Box
                        sx={{
                          backgroundColor: "#f0fdf4",
                      ...
                      >
                        <IconComponent sx={{ color: "#10B981", fontSize: 28 }} />
                      </Box>
                      <Box>
                        <Typography
                          variant="h5"
