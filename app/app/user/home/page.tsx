    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "#fafafa" }}>
      ...
      >
        ...
        <Box>
          ...
          <Box
            onClick={() => {
              if (banners.length > 4 && banners[4].redirect_url) {
                handleBannerClick(banners[4].redirect_url);
              }
            }}
            sx={{
              width: "100%",
              ...
              overflow: "hidden",
              mb: 4,
              cursor: banners.length > 4 && banners[4].redirect_url ? "pointer" : "default",
              transition: "transform 0.3s ease",
              "&:hover": banners.length > 4 && banners[4].redirect_url ? {
          ...
          >
            <ImageWithFallback
              src={banners.length > 4 ? getBannerImageUrl(banners[4].image_path) : "https://www.urbancompany.com/img?bucket=urbanclap-prod&quality=90&format=auto/w_1232,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/luminosity/1736922795409-bece35.jpeg"}
              alt={banners.length > 4 ? banners[4].title : "Shoptera Spotlight"}
              fallback="/assets/images/Image-alt.jpg"
              style={{
                width: "100%",
                height: "auto",
