...
export default function ProfilePage() {
  ...
  const [addresses, setAddresses] = useState([
    { id: 1, type: "Home", street: "123, Shanti Nagar", city: "Rajnandgaon", state: "Chhattisgarh", zip: "491441", default: true },
    { id: 2, type: "Office", street: "456, IT Park, VIP Road", city: "Raipur", state: "Chhattisgarh", zip: "492001", default: false }
  ]);
  ...
  const [bookings, setBookings] = useState([
    { id: "BK-9021", serviceType: "AC Repair & Service", date: "2026-06-15", time: "10:30 AM", amount: 1500, status: "completed" },
    { id: "BK-9042", serviceType: "Professional Deep Cleaning", date: "2026-06-22", time: "02:00 PM", amount: 2500, status: "scheduled" },
    { id: "BK-9051", serviceType: "Plumbing Solutions", date: "2026-06-24", time: "09:00 AM", amount: 800, status: "pending" }
  ]);
        ...
        <Box sx={{ width: "100%", pb: 6 }}>
          ...
          >
            ...
            <Box sx={{ minWidth: { xs: "100%", md: "auto" }, textAlign: "center" }}>
              ...
              <Chip label="Premium Customer" sx={{ background: "linear-gradient(135deg, #ffb300 0%, #ff8f00 100%)", color: "#FFFFFF", fontWeight: 700, fontSize: "0.75rem", boxShadow: "0 4px 10px rgba(255,143,0,0.2)" }} />
            </Box>
          </Paper>
